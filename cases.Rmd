...
![](images/AHposter.png){height=300px width=600px}
...
I'm hopeful for the improvements that will come with the passage of this act! I look forward to what the changes will bring in terms of improved collaboration in improving health policy in Utah. We are moving from a situation where everyone is touching different parts of the elephant ![](images/elephant.png) to a a form more like a beehive where we are working together for common goals. Quite appropriate for the Beehive State! ![](images/beehive.png)
