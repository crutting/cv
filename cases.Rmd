...
2020](https://www.nursingworld.org/practice-policy/iom-future-of-nursing-report/)
...
produce [S.B. 147](https://le.utah.gov/~2018/bills/static/SB0147.html).
...
demand](https://nursingworkforcecenters.org/wp-content/uploads/2021/12/Nurse_Demand_MDS_RevisedDecember2020.pdf).
...
2018.](https://umec-nursing.utah.gov/nursing-demand/) The shortcomings
of this methodology, namely that it is very time intensive to gather
data in this manner, made me want to look for a better way to produce a
demand study into the future.

The second source for the methodology I developed are the [Quarterly
Workforce Indicators (QWI)](https://lehd.ces.census.gov/doc/QWI_101.pdf)
...
Council](https://umec.utah.gov) to design, print, fold and mail out
thousands of paper surveys a year by hand. Back then I also built my own
data entry data bases and manually entered all of my survey responses. I
would then clean and process the data using SPSS and Excel. Finally, I
would type up my analysis and paste in all of the tables, charts and
graphs into a PDF and send that to be printed and spiral bound. I've
taught others this process while simultaneously making small
...
surveys to the high 20% range by 2020. While this is still a statistically valid sample representing the state of Utah, over time we are losing granularity to describe and model health professions at geographic levels below the entire state such as zip codes or census tracts and further analysis by sub specialty or work setting becomes more difficult. No professions are surveyed as much as health care professionals. They are over saturated and tired of responding to surveys.

**UMEC Health Profession Supply Survey Response Rates 1997 to 2020**
![](images/surveyresponse.png) in 2020 I transitioned our data
collection process to be fully online. Now I send out invitations to
take our surveys to the email addresses on file with the state
...
workforce](https://umec.utah.gov/publications/mental-health/) using
Python and R and piped the analysis to dashboards and report templates
in Tableau and R Shiny. This work serves as a code base for us to refine
with new health professions analysis as we produce them. We are
currently working on an update to our APRN workforce study that will
...
We built a graph database in our cloud environment to explore
connections and patterns and use them in our workforce projection
modeling.
...
This past year I participated with a coalition of healthcare
stakeholders across the state to develop a strategic plan to further
improve data quality by integrating health workforce supply survey
collection with the licensing process in the state and creating a broad
council of policy makers across the state to guide health workforce
policy analysis. Out of this plan, Representative Norman Thurston has
filed [HB 176 The Utah Health Workforce
Act.](https://le.utah.gov/~2022/bills/static/HB0176.html) I'm hopeful
for the improvements that will come with the passage of this act! I look
forward to what the changes will bring in terms of improved
collaboration in health policy in Utah. We are moving from a situation
where everyone is touching different parts of the elephant to a a form
more like a beehive where we are working together for common goals.
Appropriate for the beehive state!
